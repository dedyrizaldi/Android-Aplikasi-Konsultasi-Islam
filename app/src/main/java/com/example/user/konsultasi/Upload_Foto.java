...
public class Upload_Foto extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        upLoadServerUri =   URL;
        //"http://www.lp2maray.com/media/Upload_Foto.php";

        uploadButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {

                dialog = ProgressDialog.show(Upload_Foto.this, "", "Uploading file...", true);
            ...
            try {
                ...
                if(serverResponseCode == 200){
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            Toast.makeText(Upload_Foto.this, "File Upload Complete.",
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        Toast.makeText(Upload_Foto.this, "MalformedURLException", Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        Toast.makeText(Upload_Foto.this, "Got Exception : see logcat ",
                                Toast.LENGTH_SHORT).show();
                    }
                });

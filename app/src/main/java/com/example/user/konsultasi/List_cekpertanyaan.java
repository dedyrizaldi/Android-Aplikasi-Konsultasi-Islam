...
public class List_cekpertanyaan extends ListActivity {
String ip="";
	...
	class load extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(List_cekpertanyaan.this);
		...
		protected String doInBackground(String... args) {
			...
			JSONObject json = jParser.makeHttpRequest(ip+"pertanyaan/pertanyaancek_show.php", "GET", params);
...
//					startActivity(i);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(List_cekpertanyaan.this, arrayList,R.layout.desain_list, new String[] { TAG_kode_pertanyaan,TAG_kode_pengguna, TAG_pertanyaan,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});

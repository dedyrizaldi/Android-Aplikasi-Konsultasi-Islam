...
public class List_pengguna extends ListActivity {
String ip="";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				...
				Intent i = new Intent(getApplicationContext(), Detail_pengguna.class);
				i.putExtra("pk", pk);
	...
	class load extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(List_pengguna.this);
		...
		protected String doInBackground(String... args) {
			...
			JSONObject json = jParser.makeHttpRequest(ip+"pengguna/pengguna_show.php", "GET", params);
				...
				if (sukses == 1) {
					...
					for (int i = 0; i < myJSON.length(); i++) {
						...
						HashMap<String, String> map = new HashMap<String, String>();
							...
							map.put(TAG_nama_pengguna, nama_pengguna);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(List_pengguna.this, arrayList,R.layout.desain_list, new String[] { TAG_kode_pengguna,TAG_nama_pengguna, TAG_telepon,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});

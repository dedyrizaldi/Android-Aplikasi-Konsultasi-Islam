...
public class List_outbox extends ListActivity {
String ip="";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(List_outbox.this);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				...
				Intent i = new Intent(getApplicationContext(), Detail_outbox.class);
				i.putExtra("pk", pk);
	...
	class load extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(List_outbox.this);
		...
		protected String doInBackground(String... args) {
			...
			params.add(new org.apache.http.message.BasicNameValuePair("kode_user", kode_user));
			JSONObject json = jParser.makeHttpRequest(ip+"pertanyaan/pertanyaan_show_outbox.php", "GET", params);
...
//					startActivity(i);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(List_outbox.this, arrayList,R.layout.desain_list, new String[] { TAG_kode_pertanyaan,TAG_kode_pengguna, TAG_pertanyaan,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});

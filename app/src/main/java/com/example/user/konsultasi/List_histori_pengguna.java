...
public class List_histori_pengguna extends ListActivity {
String ip="";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(List_histori_pengguna.this);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				...
				Intent i = new Intent(getApplicationContext(), Detail_histori_pengguna.class);
				i.putExtra("pk", pk);
	...
	class load extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(List_histori_pengguna.this);
		...
		protected String doInBackground(String... args) {
			...
			params.add(new org.apache.http.message.BasicNameValuePair("kode_pengguna", kode_pengguna));
			JSONObject json = jParser.makeHttpRequest(ip+"pertanyaan/history_show_pengguna.php", "GET", params);
...
//					startActivity(i);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(List_histori_pengguna.this, arrayList,R.layout.desain_list, new String[] { TAG_kode_pertanyaan,TAG_kode_pengguna, TAG_pertanyaan,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});
